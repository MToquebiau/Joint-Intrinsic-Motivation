...
model_name="qmix_2a_40_30_JIM"
sce_conf_path="configs/2a_pol.json"
n_frames=5000000
n_explo_frames=4000000
episode_length=40
...
intrinsic_reward_algo="noveld" # "none" for QMIX vanilla
int_reward_coeff=1.0
int_reward_decay_fn="constant"
gamma=0.99
int_rew_enc_dim=64 # 32 for LIM
int_rew_hidden_dim=128 # 64 for LIM
scale_fac=0.5
int_rew_lr=0.0001
state_dim=40
optimal_diffusion_coeff=30 # change to 40 or 50 for harder versions
